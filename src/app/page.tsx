  ...
  export default function Home({ searchParams }: any) {
    ...
    return (
      <section className="max-w-screen-xl w-full mx-auto bg-[#f4f3f9] h-[860px] px-[8px] pt-[8px]">
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5 mb-2">
          <div className="overflow-hidden col-span-1 xl:col-span-2 ">
            <Box className="rounded-xl bg-[#ffff] min-h-[860px] shadow-lg pt-[18px] pb-[8px] px-[16px]">
              <Heading className="text-[#6b2980] text-[33px] pb-[16px]">Eventos Joinnus</Heading>
              <SearchBox onSearch={handleSearch} />
              <Box className="flex border-2 rounded-xl px-[16px] py-[8px]">
                <Heading size="5" className="pb-[4px]">Filtra los Eventos</Heading>
              ...
              <Box className="mt-[16px] flex border-2 rounded-xl pb-5">
                <table className="min-w-full divide-y divide-gray-500 text-center min-h-[384px] ">
                  <thead className="bg-[#f4f3f9]">
                    <tr>
                      <th scope="col" className="px-1 py-3 text-xs font-medium 
                      tracking-wider w-[48px] h-[40px]">
                      <Checkbox.Root
                          className={`
                      ...
                      <th scope="col" className="px-1 py-3 text-xs font-medium tracking-wider text-center w-[97px]">
                  ...
                  <tbody className="min-h-[384px]">
                    {paginatedProducts.length === 0 ? (
                      ...
                      paginatedProducts.map((item, index) => (
                        ...
                        >
                          <td className="p-[4px] whitespace-nowrap text-sm w-[48px] h-[40px]">
                            <Checkbox.Root
                              className={`
                                flex h-[18px] w-[18px] appearance-none items-center 
                                justify-center rounded-[4px] border-gray-300 border-2
                ...
                <div className="flex justify-center items-center my-5 w-[415px] mx-auto
                h-[36px] mb-[16px] min-w-[216px]  max-w-[216px]">
                  ...
                  <div className='mx-auto pb-5 flex justify-center items-center w-[415px] h-[44px]'>
                  <Button 
                  variant='classic' 
                  style={{ 
                    width: '80%', 
          ...
          <div className="overflow-hidden col-span-1 xl:col-span-3 min-h-[860px]">
            <Box className="rounded-xl ml-[16px] bg-[#ffff] min-h-[860px] shadow-lg">
              <Box>
